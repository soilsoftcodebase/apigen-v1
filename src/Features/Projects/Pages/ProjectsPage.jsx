...
import ProjectModal from "../Components/ProjectDetailsModal";
  ...
  return (
    <div className="p-8 min-h-screen bg-gradient-to-br from-gray-50 via-gray-100 to-gray-200 px-20 py-10">
      <div className="flex justify-between items-end mb-10 mt-10">
        <h1 className="text-3xl font-bold text-gray-700">Projects Dashboard</h1>
        <button
          className="ml-72 bg-green-600 text-xl flex font-bold text-white px-8 py-3 rounded shadow-lg hover:bg-green-700 focus:outline-none transition duration-300 transform hover:-translate-y-1"
          onClick={handleCreateProject}
        >
          <CirclePlusIcon className="mr-2" /> Create Project
        </button>
      </div>
      <div className="w-full h-px bg-gray-300 my-6" />
